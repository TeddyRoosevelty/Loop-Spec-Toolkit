...
- **Data model folder** — `<plugin-data-path>/data-model`.
- **Save File Name** — `<data-model-folder>/DATA-MODEL.md`.
- **File name** — always `DATA-MODEL.md`.

If the user scopes the model to a single domain or names a path, use that path instead.
